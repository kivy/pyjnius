    ...
    for index, argtype in enumerate(definition_args):
        ...
        if argtype == 'Z':
            ...
            # objects
                ...
                jcs = py_arg._JavaClass__cls_storage if JNIUS_CYTHON_3 else py_arg.__cls_storage
...
cdef jobject convert_python_to_jobject(JNIEnv *j_env, definition, obj) except *:
    ...
    if definition[0] == 'V':
        ...
        # objects
            ...
            jcs = obj._JavaClass__cls_storage if JNIUS_CYTHON_3 else obj.__cls_storage
            return jcs.j_cls
